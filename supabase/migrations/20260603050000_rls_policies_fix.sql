...
DROP POLICY IF EXISTS "profiles_developer_delete" ON profiles;
...
DROP POLICY IF EXISTS "user_roles_developer_delete" ON user_roles;
...
DROP POLICY IF EXISTS "menu_permissions_tenant_access" ON menu_permissions;
