# Supabase SQL Fix for "Database error saving new user"

## Problem
The `handle_new_user` trigger is failing when new users are created via auth.signUp.

## Solution
Run the following SQL in the Supabase Dashboard SQL Editor:

https://supabase.com/dashboard/project/udutxbyzrdwucabxqvgg/sql/new
...
1. Test user creation at https://arrudaimobi.com.br/#/admin/corretores
2. Click "Criar Usuário"
3. Fill in the form and submit
4. Should now work without "Database error saving new user"