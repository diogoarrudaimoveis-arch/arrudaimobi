...
export const automationRegistryItems: AutomationRegistryItemMock[] = [
  ...
  {
    "id": "LC-07",
    "name": "~~Builderfy gateway cron~~ (EXTERNAL — Getfy)",
    "outOfScope": true, (EXTERNAL — Getfy)",
    "type": "EXTERNAL_CRON",
    "owner": "main",
    "agentResponsible": "guardiao_chaves",
    "frequency": "* * * * *",
    "origin": "root crontab line 35",
    "commandMasked": "~~curl -fsS https://gateway.builderfy.com.br/cron?token=***MASKED*** > /dev/null 2>&1~~ (EXTERNAL — Getfy)",
    "pid": null,
    "criticality": "DANGEROUS",
    "status": "DEGRADED",
    "environment": "root2",
